...
ca65 -DWITH_SDCARD_FOR_ROOT=1 -DWITH_TWILIGHTE_BOARD=1 -DTWILIGHTE_BOARD_LINEAR_BANK=1 -ttelestrat src/shellext.asm -o shellext.ld65
ld65 -DWITH_SDCARD_FOR_ROOT=1 -DWITH_TWILIGHTE_BOARD=1 -tnone  shellext.ld65 -o shellext.rom  -Ln shellext.sym libs/lib8/twil.lib libs/lib8/ch376.lib
